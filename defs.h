...
// All -ve inputs at -VREF (AVss) and CH0 changing between AN3,AN4, and AN5
...
#define REACQUIRE_THRESHOLD 1250
...
// The HIGH_SPEED definition is used to increase the ADC sample
// rate to support faster motors.  If HIGH_SPEED is defined, Timer3
// will be used to trigger the ADC conversions.  This will allow 
// a different sample rate than the PWM frequency.  However, 
// BEMF sampling will no longer be synced to the PWM cycle.  Therefore
// a small amount of RC filtering must be placed on the A/D inputs
// to remove PWM ripple.
//#define	HIGH_SPEED	1
// This is the value loaded to the TIMER 3 period register in units of Tcy
#define		HS_SAMPLING_PERIOD	625		// for 20 MIPS, 625Tcy = 32Khz sample rate
